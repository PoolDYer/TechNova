...
// Endpoint para reenviar correo de confirmación de email (desde Admin)
    try {
        ...
        if (!email || !confirmationUrl) {
            return res.status(400).json({ 
                success: false, 
                error: 'Email y URL de confirmación requeridos' 
            });
        }
                ...
                <table role="presentation" style="width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; text-align: center;">
                            ...
                            <h2 style="color: #1e293b; margin: 0 0 10px 0; font-size: 24px;">
                                ¡Bienvenido a TechNova, ${fullName || 'usuario'}!
                            </h2>
                            <p style="color: #64748b; margin: 0 0 30px 0; font-size: 16px; line-height: 1.5;">
                                Gracias por registrarte en nuestra plataforma. Para completar tu registro y acceder a todas las funciones, por favor verifica tu correo electrónico.
                            </p>
                        </td>
                    </tr>
                    ...
                    <!-- Fallback Info -->
                    <tr>
                        <td style="padding: 0 30px 30px 30px; background-color: #f8fafc; border-radius: 8px; margin: 0 30px;">
                            <p style="margin: 15px 0; color: #64748b; font-size: 13px;">
                                Si el botón no funciona, copia y pega este enlace en tu navegador:
                            </p>
                            <p style="margin: 10px 0; word-break: break-all; color: #3b82f6; font-size: 12px; font-family: 'Courier New', monospace;">
                                ${confirmationUrl}
                            </p>
                        </td>
                    </tr>
